      ...
      <div className="relative z-10 container-custom pt-20">
        <div className="max-w-3xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight animate-slide-up">
            Find Your <span className="text-gradient-gold">Flow </span>
          </h1>

          <p
            className="text-lg sm:text-xl text-white/70 mb-8 leading-relaxed max-w-xl animate-slide-up"
            style={{
              animationDelay: "0.1s",
            }}
          >
